...
public class JSWebKitTestActivity extends Activity {
	/*
	 * Tag del Log
	 */
	private final static String LOG_TAG = "JSWebKitTestActivity";
	/*
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Abilitiamo la gestione del JavaScript
        HelloWorldBridge jsBridge = new HelloWorldBridge();
	...
	public void loadUri(View button) {
		...
		loadUriOnWebView("file:///android_asset/test_js.html");
	}
	...
	/**
	 * Classe che implementa una semplice operazione di sayHello
	 */
	public class HelloWorldBridge{
