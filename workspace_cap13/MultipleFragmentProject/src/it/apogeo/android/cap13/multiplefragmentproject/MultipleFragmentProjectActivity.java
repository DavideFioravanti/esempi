...
/**
 * Questa classe descrive l'Activity per la gestione della navigazione 
 * 
 * @author Massimo Carli
 *
 */
public class MultipleFragmentProjectActivity extends Activity {
	
	/*
	 * Valore del tag per il log
	 */
	private final static String LOG_TAG = "MultipleFragmentProjectActivity";
